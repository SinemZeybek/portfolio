...
export const projects: Project[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Built a mobile-first navigation redesign: a fixed bottom icon bar with active-page indicators on mobile, collapsing the desktop top bar down to just the logo and search on small screens.",
